...
class ProfileTable {
  ...
  String get keep => 'static const List<int> keep = '
      'const ${getActionTagsList(memberData, tagOffset, oIndex, "K")}';

  String get remove => 'static const List<int> remove = '
      'const ${getActionTagsList(memberData, tagOffset, oIndex, "XC")}';
