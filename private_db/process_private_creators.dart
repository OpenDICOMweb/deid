...
Map getElement(int index) {
  ...
  int tag = row[0];
  elements['tag'] = tag;
  elements['group'] = Tag.toGroup(tag);
  elements['element'] = Tag.toElt(tag);
  elements['vr'] = row[1];
  elements['vm'] = row[2];
...
String toDartString(Map<String, dynamic> creators) {
  var out = '{\n';
...
String toCreator(Map<String, String> values, String out) {
