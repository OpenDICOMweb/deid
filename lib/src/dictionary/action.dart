...
class Action {
  ...
  static Element replaceNoValues(Dataset ds, Tag tag) => ds.noValues(tag.code);

  /// Remove the attribute'.
  static Element delete(Dataset ds, Tag tag) => ds.remove(tag.code);
  ...
  /// (Type 3 versus Type 2 versus Type 1)';
  static Element removeUnlessZeroOrDummy(
