...
class GlobalRule {
  static const List<int> allowedGroupNumbers = const [0x0018, 0x0020, 0x0028, 0x0050, 0x0060];
...
class GlobalRuleType {
  ...
  static const GlobalRuleType keepGroup = const GlobalRuleType('@keepGroup', 'uint', 1, 1, 1);
  static const GlobalRuleType keepGroup18 = const GlobalRuleType('@keepGroup18', '*', 0, 0, 0);
  static const GlobalRuleType keepGroup20 = const GlobalRuleType('@keepGroup20', '*', 0, 0, 0);
  static const GlobalRuleType keepGroup28 = const GlobalRuleType('@keepGroup28', '*', 0, 0, 0);
  static const GlobalRuleType keepGroup50 = const GlobalRuleType('@keepGroup50', '*', 0, 0, 0);
  static const GlobalRuleType keepGroup60 = const GlobalRuleType('@keepGroup60', '*', 0, 0, 0);
  ...
  static const GlobalRuleType keepPrivateGroup = const GlobalRuleType('@pkeepPrivateGroup', 'private', 1, 1, 0);

  static const GlobalRuleType removeUncheckedElements = const GlobalRuleType('@removeUncheckedElements', '*', 0, 0, 0);

  static const GlobalRuleType removeGroup = const GlobalRuleType('@removeGroup', 'uint', 1, 1, 1);
  static const GlobalRuleType removeGroup18 = const GlobalRuleType('@removeGroup18', '*', 0, 0, 0);
  static const GlobalRuleType removeGroup20 = const GlobalRuleType('@removeGroup20', '*', 0, 0, 0);
  static const GlobalRuleType removeGroup28 = const GlobalRuleType('@removeGroup28', '*', 0, 0, 0);
  static const GlobalRuleType removeGroup50 = const GlobalRuleType('@removeGroup50', '*', 0, 0, 0);
  static const GlobalRuleType removeGroup60 = const GlobalRuleType('@removeGroup60', '*', 0, 0, 0);
  static const GlobalRuleType removeCurves = removeGroup50;
  static const GlobalRuleType removeOverlays = removeGroup60;

  static const GlobalRuleType removeAllPrivateGroups = const GlobalRuleType('@removePrivateGroups', '', 0, 0, 0);
  static const GlobalRuleType removePrivateGroup = const GlobalRuleType('@removePrivateGroup', 'string', 1, 1, 0);

  //TODO: these might work with whole groups
  static const GlobalRuleType ifExists = const GlobalRuleType('@ifExists', '*', 1, 1, 2, const ['tag']);
  static const GlobalRuleType ifBlank = const GlobalRuleType('@ifBlank', 'string', 1, 1, 2, const ['tag']);
  static const GlobalRuleType ifEquals = const GlobalRuleType('@ifEquals', '*', 2, 2, 2, const ['tag', 'string']);
  static const GlobalRuleType ifContains = const GlobalRuleType('@ifContains', 'string', 2, 2, 2,
                                               const ['tag', 'string']);
  static const GlobalRuleType ifMatches = const GlobalRuleType('@ifMatches', '*', 2, 2, 2, const ['tag', 'string']);
