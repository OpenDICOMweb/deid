...
Profile read_profile_file(String inPath) {
...
void write_profile_file(String outPath, Profile profile) {
  var ext = path.extension(outPath);
  if (ext == ".json") {
    File inFile = new File(outPath);
    inFile.writeAsStringSync(profile.json);
  }
